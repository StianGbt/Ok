...
def menu(my_name,my_id):
	...
	S.tian17(f'>> Your Idz : '+str(my_id))
	S.tian17(f'>> Your Ip  : {ip}')
	print('')
	...
	if _____Septian__Gabut_____ in ['1']:
		dump_massal()
	elif _____Septian__Gabut_____ in ['2']:
		dump_follower()
	elif _____Septian__Gabut_____ in ['3']:
		error()
	elif _____Septian__Gabut_____ in ['4']:
		crack_file()
	elif _____Septian__Gabut_____ in ['5']:
		result()
